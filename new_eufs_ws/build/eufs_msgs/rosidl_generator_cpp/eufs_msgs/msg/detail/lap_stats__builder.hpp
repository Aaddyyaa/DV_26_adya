...
class Init_LapStats_num_cones_hit
{
public:
  explicit Init_LapStats_num_cones_hit(::eufs_msgs::msg::LapStats & msg)
  : msg_(msg)
  {}
  ::eufs_msgs::msg::LapStats num_cones_hit(::eufs_msgs::msg::LapStats::_num_cones_hit_type arg)
  {
    msg_.num_cones_hit = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_LapStats_num_cones_hit oscillation_number(::eufs_msgs::msg::LapStats::_oscillation_number_type arg)
  {
    msg_.oscillation_number = std::move(arg);
    return Init_LapStats_num_cones_hit(msg_);
  }
