...
struct ConeAssociationArrayArrayStamped_
{
  ...
  using _associations_type =
    std::vector<eufs_msgs::msg::ConeAssociationArray_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::ConeAssociationArray_<ContainerAllocator>>>;
  ...
  Type & set__associations(
    const std::vector<eufs_msgs::msg::ConeAssociationArray_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::ConeAssociationArray_<ContainerAllocator>>> & _arg)
  {
