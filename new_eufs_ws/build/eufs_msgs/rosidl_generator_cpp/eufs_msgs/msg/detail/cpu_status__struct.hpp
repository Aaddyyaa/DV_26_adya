...
#ifndef EUFS_MSGS__MSG__DETAIL__CPU_STATUS__STRUCT_HPP_
#define EUFS_MSGS__MSG__DETAIL__CPU_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__eufs_msgs__msg__CpuStatus __attribute__((deprecated))
#else
# define DEPRECATED__eufs_msgs__msg__CpuStatus __declspec(deprecated)
#endif
...
struct CpuStatus_
{
  ...
  using ConstRawPtr =
    const eufs_msgs::msg::CpuStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<eufs_msgs::msg::CpuStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<eufs_msgs::msg::CpuStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      eufs_msgs::msg::CpuStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<eufs_msgs::msg::CpuStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<eufs_msgs::msg::CpuStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<eufs_msgs::msg::CpuStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<eufs_msgs::msg::CpuStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__eufs_msgs__msg__CpuStatus
    std::shared_ptr<eufs_msgs::msg::CpuStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__eufs_msgs__msg__CpuStatus
    std::shared_ptr<eufs_msgs::msg::CpuStatus_<ContainerAllocator> const>
...
using CpuStatus =
  eufs_msgs::msg::CpuStatus_<std::allocator<void>>;
...
#endif  // EUFS_MSGS__MSG__DETAIL__CPU_STATUS__STRUCT_HPP_
