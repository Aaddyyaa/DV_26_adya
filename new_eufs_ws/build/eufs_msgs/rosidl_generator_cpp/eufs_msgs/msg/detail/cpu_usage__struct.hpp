...
struct CpuUsage_
{
  ...
  _all_type all;
  using _cpus_type =
    std::vector<eufs_msgs::msg::CpuStatus_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::CpuStatus_<ContainerAllocator>>>;
  _cpus_type cpus;
  ...
  Type & set__cpus(
    const std::vector<eufs_msgs::msg::CpuStatus_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<eufs_msgs::msg::CpuStatus_<ContainerAllocator>>> & _arg)
  {
    this->cpus = _arg;
    return *this;
  }
