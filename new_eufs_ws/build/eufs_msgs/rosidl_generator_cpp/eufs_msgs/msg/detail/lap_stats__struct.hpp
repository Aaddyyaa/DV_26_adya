...
struct LapStats_
{
  ...
  using _num_cones_hit_type =
    int64_t;
  _num_cones_hit_type num_cones_hit;
  ...
  Type & set__num_cones_hit(
    const int64_t & _arg)
  {
    this->num_cones_hit = _arg;
    return *this;
  }
  ...
  bool operator==(const LapStats_ & other) const
  {
    ...
    if (this->num_cones_hit != other.num_cones_hit) {
      return false;
    }
    return true;
  }
