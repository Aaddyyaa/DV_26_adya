...
bool eufs_msgs__msg__lap_stats__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // num_cones_hit
    PyObject * field = PyObject_GetAttrString(_pymsg, "num_cones_hit");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->num_cones_hit = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * eufs_msgs__msg__lap_stats__convert_to_py(void * raw_ros_message)
{
  ...
  {  // num_cones_hit
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->num_cones_hit);
    {
      int rc = PyObject_SetAttrString(_pymessage, "num_cones_hit", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
