...
class LapStats(metaclass=Metaclass_LapStats):
    ...
    def __init__(self, **kwargs):
        ...
        self.num_cones_hit = kwargs.get('num_cones_hit', int())
    ...
    def __eq__(self, other):
        ...
        if self.oscillation_number != other.oscillation_number:
            return False
        if self.num_cones_hit != other.num_cones_hit:
            return False
        return True
    ...
    @builtins.property
    def num_cones_hit(self):
        """Message field 'num_cones_hit'."""
        return self._num_cones_hit

    @num_cones_hit.setter
    def num_cones_hit(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'num_cones_hit' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'num_cones_hit' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._num_cones_hit = value
