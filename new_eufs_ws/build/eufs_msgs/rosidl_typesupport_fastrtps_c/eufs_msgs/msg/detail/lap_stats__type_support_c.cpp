  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: num_cones_hit
  {
    cdr << ros_message->num_cones_hit;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name num_cones_hit
  {
    size_t item_size = sizeof(ros_message->num_cones_hit);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, num_cones_hit) +
      last_member_size
      ) == ret_val;
  }
