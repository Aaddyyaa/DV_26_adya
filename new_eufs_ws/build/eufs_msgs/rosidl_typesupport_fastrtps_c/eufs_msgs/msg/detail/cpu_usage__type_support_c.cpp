...
#include "eufs_msgs/msg/detail/cpu_usage__rosidl_typesupport_fastrtps_c.h"
...
#include "eufs_msgs/msg/detail/cpu_status__functions.h"  // all, cpus
...
size_t get_serialized_size_eufs_msgs__msg__CpuStatus(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_eufs_msgs__msg__CpuStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eufs_msgs, msg, CpuStatus)();


using _CpuUsage__ros_msg_type = eufs_msgs__msg__CpuUsage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: all
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, eufs_msgs, msg, CpuStatus
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->all, cdr))
    {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: cpus
  {
    ...
    if (ros_message->cpus.data) {
      eufs_msgs__msg__CpuStatus__Sequence__fini(&ros_message->cpus);
    }
    if (!eufs_msgs__msg__CpuStatus__Sequence__init(&ros_message->cpus, size)) {
...
size_t get_serialized_size_eufs_msgs__msg__CpuUsage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CpuUsage__ros_msg_type * ros_message = static_cast<const _CpuUsage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_eufs_msgs__msg__CpuStatus(
...
static uint32_t _CpuUsage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eufs_msgs__msg__CpuUsage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eufs_msgs
size_t max_serialized_size_eufs_msgs__msg__CpuUsage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: all
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_eufs_msgs__msg__CpuStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = eufs_msgs__msg__CpuUsage;
    is_plain =
      (
...
static size_t _CpuUsage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eufs_msgs__msg__CpuUsage(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eufs_msgs, msg, CpuUsage)() {
