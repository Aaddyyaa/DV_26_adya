...
#include "eufs_msgs/srv/detail/get_map__rosidl_typesupport_fastrtps_c.h"
...
using _GetMap_Request__ros_msg_type = eufs_msgs__srv__GetMap_Request;
...
size_t get_serialized_size_eufs_msgs__srv__GetMap_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetMap_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eufs_msgs__srv__GetMap_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eufs_msgs
size_t max_serialized_size_eufs_msgs__srv__GetMap_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eufs_msgs__srv__GetMap_Request;
    is_plain =
      (
...
static size_t _GetMap_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eufs_msgs__srv__GetMap_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eufs_msgs, srv, GetMap_Request)() {
...
using _GetMap_Response__ros_msg_type = eufs_msgs__srv__GetMap_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: map_path
  {
    size_t size = ros_message->map_path.size;
    auto array_ptr = ros_message->map_path.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: map_path
  {
    ...
    if (ros_message->map_path.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->map_path);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->map_path, size)) {
      fprintf(stderr, "failed to create array for field 'map_path'");
      return false;
    }
    auto array_ptr = ros_message->map_path.data;
    for (size_t i = 0; i < size; ++i) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eufs_msgs
size_t get_serialized_size_eufs_msgs__srv__GetMap_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetMap_Response__ros_msg_type * ros_message = static_cast<const _GetMap_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_eufs_msgs__srv__GetMap_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eufs_msgs
size_t max_serialized_size_eufs_msgs__srv__GetMap_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = eufs_msgs__srv__GetMap_Response;
    is_plain =
      (
...
static size_t _GetMap_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eufs_msgs__srv__GetMap_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eufs_msgs, srv, GetMap_Response)() {
...
// already included above
// #include "eufs_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "eufs_msgs/srv/get_map.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eufs_msgs, srv, GetMap)() {
