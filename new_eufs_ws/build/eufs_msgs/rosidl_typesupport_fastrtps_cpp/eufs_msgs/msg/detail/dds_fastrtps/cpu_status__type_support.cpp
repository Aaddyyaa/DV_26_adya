...
#include "eufs_msgs/msg/detail/cpu_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eufs_msgs::msg::CpuStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eufs_msgs::msg::CpuStatus & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eufs_msgs::msg::CpuStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eufs_msgs::msg::CpuStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eufs_msgs::msg::CpuStatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<eufs_msgs::msg::CpuStatus>()
{
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_CpuStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, msg, CpuStatus)() {
  return &eufs_msgs::msg::typesupport_fastrtps_cpp::_CpuStatus__handle;
}
