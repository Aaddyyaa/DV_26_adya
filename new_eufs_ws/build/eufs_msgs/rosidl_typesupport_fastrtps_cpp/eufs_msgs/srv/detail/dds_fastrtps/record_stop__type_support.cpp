...
#include "eufs_msgs/srv/detail/record_stop__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eufs_msgs::srv::RecordStop_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eufs_msgs::srv::RecordStop_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eufs_msgs::srv::RecordStop_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RecordStop_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const eufs_msgs::srv::RecordStop_Request *>(
...
static size_t _RecordStop_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RecordStop_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RecordStop_Request__callbacks = {
  "eufs_msgs::srv",
  "RecordStop_Request",
...
static rosidl_message_type_support_t _RecordStop_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RecordStop_Request__callbacks,
...
{
  return &eufs_msgs::srv::typesupport_fastrtps_cpp::_RecordStop_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = eufs_msgs::srv::RecordStop_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eufs_msgs::srv::RecordStop_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<eufs_msgs::srv::RecordStop_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RecordStop_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const eufs_msgs::srv::RecordStop_Response *>(
...
static size_t _RecordStop_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RecordStop_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RecordStop_Response__callbacks = {
  "eufs_msgs::srv",
  "RecordStop_Response",
...
static rosidl_message_type_support_t _RecordStop_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RecordStop_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &eufs_msgs::srv::typesupport_fastrtps_cpp::_RecordStop_Response__handle;
}
...
static service_type_support_callbacks_t _RecordStop__callbacks = {
  "eufs_msgs::srv",
  "RecordStop",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, srv, RecordStop_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, srv, RecordStop_Response)(),
...
static rosidl_service_type_support_t _RecordStop__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RecordStop__callbacks,
...
{
  return &eufs_msgs::srv::typesupport_fastrtps_cpp::_RecordStop__handle;
}
